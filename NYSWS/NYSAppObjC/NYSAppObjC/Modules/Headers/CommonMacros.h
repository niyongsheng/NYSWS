...
#define NBottomHeight (NStatusBarHeight == 44 ? 34 : 0)
...
#define IMAGE_FULL_STR(str)     [NAppConfig.obsDomain stringByAppendingString:str]
#define IMAGE_FULL_URL(str)     [NSURL URLWithString:[NAppConfig.obsDomain stringByAppendingString:str]]
